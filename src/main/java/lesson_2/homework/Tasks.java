...
public class Tasks {
     ...
     * Нельзя изменять типы и значения переменных. Внеси исправления только в самих условиях.
     */
...
//        }
    ...
    /**
     * Расставь два ключевых слова "break" так, чтобы в консоль было выведено значение: 12210355
     */
